...
class IScore(forms.Form):
    ...
    student_num = forms.CharField(label="", \
        widget=forms.TextInput(attrs={"readonly":True, \
            "disabled":True,"style":"width:150px"}))
    student = forms.CharField(label="", \
        widget=forms.TextInput(attrs={"readonly":True, \
            "disabled":True,"style":"width:150px"}))
    ...
    def clean_score(self):
        ...
        if score > 100 or score < -3:
            raise forms.ValidationError('应该为-3~100的整数')
        else:
            return score
...
class CScore(forms.Form):
    ...
    student_num = forms.CharField(label="", \
        widget=forms.TextInput(attrs={"readonly":True,"style":"width:150px"}))
    student = forms.CharField(label="", \
        widget=forms.TextInput(attrs={"readonly":True,"width":"10","style":"width:150px"}))
    old_score = forms.CharField(label="", \
        widget=forms.TextInput(attrs={"readonly":True,"style":"width:150px"}))
    change_to = forms.IntegerField(label="", \
